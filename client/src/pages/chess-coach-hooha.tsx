...
import { useTheoraEngine } from "@/hooks/use-theoria-engine";
...
export default function ChessCoachHooha() {
  ...
  const { evaluation, isReady, hasError, evaluate, evaluateAsync, endBatch } = useTheoraEngine();
