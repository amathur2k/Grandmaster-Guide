    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Chess Analysis is an interactive chess analysis tool that combines a world-class chess
            computer with a personal chess coach. It allows you to import, play through, and analyse
            chess games with computer evaluations and natural language coaching explanations.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed">
            ...
            <li>Attempt to reverse-engineer or copy the underlying computer analysis or chess coaching systems</li>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3 text-muted-foreground leading-relaxed">
            <p>
              ...
              are generated by AI and verified against the chess computer.
              While we strive for accuracy, AI-generated content may contain errors or inaccuracies.
            </p>
            <p>
              You should not rely solely on this Service for competitive play decisions. Our approach of
              chess coaching, computer verified reflects our intent to ground coaching output in computer
